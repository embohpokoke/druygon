...
var POKEMON_DB = [
  ...
  { id: 'caterpie', name: 'Caterpie', emoji: '🐛', img: 'caterpie.png', type: 'Serangga', rarity: 'common', baseHP: 30, attack: 15, catchRate: 0.7, route: 1, minLevel: 1 },
  { id: 'weedle', name: 'Weedle', emoji: '🐝', img: 'weedle.png', type: 'Serangga', rarity: 'common', baseHP: 32, attack: 18, catchRate: 0.7, route: 1, minLevel: 1 },
  ...
  { id: 'eevee', name: 'Eevee', emoji: '✨', img: 'eevee.png', type: 'Normal', rarity: 'uncommon', baseHP: 50, attack: 35, catchRate: 0.4, route: 1, minLevel: 3 },
  { id: 'meowth', name: 'Meowth', emoji: '😺', img: 'meowth.png', type: 'Normal', rarity: 'uncommon', baseHP: 45, attack: 30, catchRate: 0.4, route: 1, minLevel: 3 },
  ...
  { id: 'geodude', name: 'Geodude', emoji: '🪨', img: 'geodude.png', type: 'Batu', rarity: 'common', baseHP: 60, attack: 40, catchRate: 0.7, route: 2, minLevel: 6 },
  { id: 'zubat', name: 'Zubat', emoji: '🦇', img: 'zubat.png', type: 'Racun', rarity: 'common', baseHP: 50, attack: 35, catchRate: 0.7, route: 2, minLevel: 6 },
  ...
  { id: 'sandshrew', name: 'Sandshrew', emoji: '🏜️', img: 'sandshrew.png', type: 'Tanah', rarity: 'common', baseHP: 55, attack: 38, catchRate: 0.7, route: 2, minLevel: 6 },
  ...
  { id: 'onix', name: 'Onix', emoji: '🐍', img: 'onix.png', type: 'Batu', rarity: 'uncommon', baseHP: 80, attack: 45, catchRate: 0.4, route: 2, minLevel: 8 },
  { id: 'haunter', name: 'Haunter', emoji: '👻', img: 'haunter.png', type: 'Hantu', rarity: 'uncommon', baseHP: 70, attack: 60, catchRate: 0.4, route: 2, minLevel: 8 },
  ...
  { id: 'bellsprout', name: 'Bellsprout', emoji: '🌾', img: 'bellsprout.png', type: 'Rumput', rarity: 'common', baseHP: 55, attack: 50, catchRate: 0.7, route: 3, minLevel: 11 },
  ...
  { id: 'lapras', name: 'Lapras', emoji: '🐋', img: 'lapras.png', type: 'Air', rarity: 'rare', baseHP: 100, attack: 75, catchRate: 0.15, route: 3, minLevel: 14 },
  ...
  { id: 'dratini', name: 'Dratini', emoji: '🐍✨', img: 'dratini.png', type: 'Naga', rarity: 'common', baseHP: 80, attack: 60, catchRate: 0.7, route: 4, minLevel: 16 },
  { id: 'growlithe', name: 'Growlithe', emoji: '🐕‍🦺', img: 'growlithe.png', type: 'Api', rarity: 'common', baseHP: 75, attack: 65, catchRate: 0.7, route: 4, minLevel: 16 },
  { id: 'dragonair', name: 'Dragonair', emoji: '🐉', img: 'dragonair.png', type: 'Naga', rarity: 'uncommon', baseHP: 95, attack: 80, catchRate: 0.4, route: 4, minLevel: 17 },
  { id: 'arcanine', name: 'Arcanine', emoji: '🦁', img: 'arcanine.png', type: 'Api', rarity: 'uncommon', baseHP: 100, attack: 90, catchRate: 0.4, route: 4, minLevel: 18 },
...
var POKEBALL_TYPES = {
  ...
  greatball: { name: 'Great Ball', emoji: '🔵', img: 'pokeball-sm.png', modifier: 1.5, price: 150 },
  ultraball: { name: 'Ultra Ball', emoji: '🟡', img: 'pokeball-sm.png', modifier: 2, price: 400 },
  masterball: { name: 'Master Ball', emoji: '🟣', img: 'pokeball-sm.png', modifier: 100, price: 2000 }
};
